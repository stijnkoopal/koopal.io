...
const About = () => (
  <div>
    ...
    <ul>
      <li>Are you curious? Contact me!</li>
      <li>Need someone to help you and your software get to the next level? Contact me!</li>
      <li>Anything related to sotware development and its process? Contact me!</li>
      <li>Basically, it comes to this: I can help you!</li>
    </ul>
  </div>
)
